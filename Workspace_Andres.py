...
def main():
    ...
    while not moet_afsluiten:
        ...
        # floor
        renderer.copy(color_textures[5], srcrect=(0, 0, 1, 1),
                      dstrect=(0, window.size[1] / 2, window.size[0], window.size[1] / 2))
        ...
        renderer.copy(scannergun_sprite, srcrect=(0, 0, scannergun_sprite.size[0], scannergun_sprite.size[1]),
                      dstrect=(299, 415, scannergun_sprite.size[0], scannergun_sprite.size[1]))
        end_time = time.time()
